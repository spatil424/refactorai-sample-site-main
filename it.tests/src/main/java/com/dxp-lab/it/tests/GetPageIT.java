...
import com.adobe.cq.cloud.testing.it.rules.AuthorPublishEnvironmentRule;
import com.adobe.cq.cloud.testing.it.rules.CQRule;
...
public class GetPageIT {
    ...
    // The AuthorPublishEnvironmentRule represents an AEM Cloud Service
    // environment. The rule will read the environment variables set up in
    // the testing environment.

    @ClassRule
    public static final AuthorPublishEnvironmentRule cqBaseClassRule = new AuthorPublishEnvironmentRule();
    ...
    // Thanks to the AuthorPublishEnvironmentRule, we can create two CQClient instances
